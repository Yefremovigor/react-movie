...
const Nav = ({className}) => {
    const navClassName = className ? `nav ${className}` : 'nav';
    return (
        <>
            <nav className={navClassName}>
                <ul className="nav__list">
                    <li className="nav__item">
                        <a className="nav__link" href="/serch">Поиск фильмов</a>
                    </li>
                    <li className="nav__item">
                        <a className="nav__link" href="/my">Мои фильмы <span className="nav__counter">2</span></a>
                    </li>
                    <li className="nav__item">
                        <a className="nav__link" href="/login">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M6 12L15 12M15 12L12.5 14.5M15 12L12.5 9.5" stroke="currentColor" stroke-width="1.5"
